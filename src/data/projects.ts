...
export const projects: Project[] = [
  ...
  // ========================================
  {
    ...
    technologies: ['React', 'TypeScript', 'Node.js', 'Express', 'PostgreSQL', 'Stripe', 'Tailwind CSS', 'Jest', 'React Testing Library'],
    type: 'fullstack',
  ...
  // ========================================
  {
    ...
    technologies: ['React Native', 'TypeScript', 'Expo', 'Firebase', 'React Navigation', 'Jest', 'React Native Testing Library'],
    type: 'mobile',
  ...
  // ========================================
  {
    ...
    technologies: ['React', 'TypeScript', 'Vite', 'Tailwind CSS', 'Framer Motion', 'Jest', 'React Testing Library'],
    type: 'web',
